...
class ControllerCommonDashboard extends Controller {
	public function index() {
				...
				if($this->config->get('config_maintenance')){
					...
					$data['maintenanceheader'] = '<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' . $this->language->get('entry_maintenance') . '</div>';
				} else {
					$data['maintenanceheader'] = false;
				}
