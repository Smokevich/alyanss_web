nitro.register('smusher', (function($) {
    ...
    var getImageList = function(callback) {
        ...
        if ($('#smushTargetPath').val().length > 0) {
            smushTargetPath = encodeURIComponent($('#smushTargetPath').val());
        }

        $.ajax({
            url: 'index.php?route=extension/module/nitro/smush_init&user_token=' + token,
            dataType: 'json',
            type: 'POST',
            data: {
    ...
    var refresh_progress = function(auto_refresh) {
        ...
        refreshXHR = $.ajax({
            url: 'index.php?route=extension/module/nitro/smush_get_progress&user_token=' + token,
            type: 'GET',
            dataType: 'json',
            cache: false,
            success: function(data) {
    ...
    var smush = function(action) {
        ...
        smushXHR = $.ajax({
            url: 'index.php?route=extension/module/nitro/smush_' + action + '&user_token=' + token,
            type: 'GET',
            dataType: 'text',
            data: {
                method: method,
    ...
    var stopSmushing = function() {
        ...
        $.ajax({
            url: 'index.php?route=extension/module/nitro/smush_pause&user_token=' + token,
            type: 'GET',
            dataType: 'json',
            cache: false,
